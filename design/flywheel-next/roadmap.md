...
| 4 | Dispatch | Dispatch as a host: the four jobs, the receiver, the interpreter in-process and as a session, triage placements, several instances on one host, users and ownership, environments | A.25, A.26, A.29, A.30 |
