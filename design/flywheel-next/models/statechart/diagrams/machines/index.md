...
| `capture` | object | core | 1 | capture | 4, 19, 106, 111, 112, 114, 115, 178, 181 | [capture.svg](capture.svg) |
| `claim` | object | core | 4 | claim | 23, 97, 98, 105, 121, 195, 198, 200, 211 | [claim.svg](claim.svg) |
| `curation` | object | core | 3 | curation | 4, 20, 58, 60, 108, 110, 116, 118, 171, 182, 188 | [curation.svg](curation.svg) |
...
| `organization` | object | core | 1 | organization | 204, 207, 208 | [organization.svg](organization.svg) |
| `place` | template | core | 2 | template | 4, 42, 45, 46, 51, 52, 55 | [place.svg](place.svg) |
| `planning` | object | core | 2 | planning | 4, 28, 29, 60, 64, 98, 101, 102, 104, 171, 172, 182, 198, 199, 200, 202 | [planning.svg](planning.svg) |
...
| `session` | template | core | 4 | template | 4, 24, 65, 66, 67, 70, 71, 72, 73, 80, 93, 171, 173, 174, 190, 196, 197 | [session.svg](session.svg) |
...
| `unit` | object | core | 3 | unit | 4, 5, 13, 16, 17, 31, 35, 36, 37, 57, 60, 74, 172 | [unit.svg](unit.svg) |
...
| machine | kind | tier | version | object | satisfies | diagram |
|---|---|---|---|---|---|---|
| `host` | engine | core | 4 | host | 4, 32, 55, 96, 147, 149, 150, 151, 186, 196, 205 | [host.svg](host.svg) |
| `lease` | engine | core | 2 | lease | 128, 134, 147, 149, 150 | [lease.svg](lease.svg) |
| `plan` | engine | core | 2 | plan | 7, 8, 9, 11, 15, 83, 86, 148 | [plan.svg](plan.svg) |
| `response` | engine | core | 3 | response | 1, 3, 4, 6, 12, 137, 153, 154, 193, 194 | [response.svg](response.svg) |
| `sink` | engine | core | 1 | sink | 2, 8, 14, 18, 68, 82, 148, 152, 155 | [sink.svg](sink.svg) |
