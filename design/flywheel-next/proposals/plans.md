...
| **Pro** | 1 + 2 | one person with more to build | Hobby plus pools with an included hour allowance and metered overage, the store, the book view, presets, and immediate triage and free text in chat | 3 organizations · 1 member · pool hosts up to 8 GB · included pool hours · included model budget |
...
- `fw.ff.federation` — tier 3, both shapes: the organization's key and stores in
...
our side is the control plane alone: a **registry** of organization names, tier,
