...
| `hosted-design.md` | the narrative behind **A.34**: the physical design for one flywheel on the hosted tier, the machines that exist and what each holds, one tick step by step, where the data is and what an attacker gets, the four tiers, one-shot scheduling per flywheel, and the OIDC-federated enterprise variant. Kept as narrative; nothing here awaits a ruling | 2026-09-08 |
