...
| `fundamentals-and-claims.md` | OpenSpec as a named given beside git, the claim shape as core and the schemas, instructions and skills over a block as extensible, claim granularity as a default instruction, a unit that cites the coarse claim it serves or none at all with the unclaimed ones read in one batch on the review surface, and the fundamentals part of the book, a mechanism-free requirements statement written as clauses with the claims included under them. **Proposes 34a, 223a, 317, 318; amends the preamble, 120, 190, 208, section 8 and section 10** | 2026-09-09 |
